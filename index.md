...
venue: "University of California, Santa Cruz"        # brief name of host site without address (e.g., "Euphoric State University")
address: "130 McAllister Way, Santa Cruz, California"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "April 24-25, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate:  2019-04-25        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Umi Hoshijima", "Jane Doe"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
